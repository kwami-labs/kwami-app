...
<template>
  ...
  <PanelSection :title="t('audioPanel.audioReactivity')" icon="ph:microphone-duotone" collapsible>
    ...
    <div v-if="audio.enabled" class="slider-group" style="margin-top: 12px">
      <BaseSlider
        :label="t('audioPanel.intensity')"
        :description="t('audioPanel.intensityDesc')"
        :min="0.1"
        :max="4"
        :step="0.1"
      ...
      />
      <BaseSlider
        :label="t('audioPanel.spikeDensity')"
        :description="t('audioPanel.spikeDensityDesc')"
        :min="0"
        :max="4"
        :step="0.1"
        v-model="audio.spikeDensity"
      />
      <BaseSlider
        :label="t('audioPanel.threshold')"
        :description="t('audioPanel.thresholdDesc')"
        :min="0.01"
        :max="0.2"
        :step="0.005"
        v-model="audio.sensitivity"
      />
    </div>
  </PanelSection>
  ...
  <PanelSection
    v-if="audio.enabled"
    :title="t('audioPanel.audioDynamics')"
  ...
  >
    ...
    <div class="slider-group">
      <BaseSlider
        :label="t('audioPanel.smoothness')"
        :description="t('audioPanel.smoothnessDesc')"
        :min="0"
        :max="1"
        :step="0.05"
        v-model="audio.responseSpeed"
      />
      <BaseSlider
        :label="t('audioPanel.punch')"
        :description="t('audioPanel.punchDesc')"
        :min="0"
        :max="1"
        :step="0.05"
        v-model="audio.transientBoost"
      />
    </div>
  ...
  <PanelSection
    v-if="audio.enabled"
    :title="t('audioPanel.frequencyBalance')"
  ...
  >
    <template #actions>
      <button
        class="dice-btn"
        @click="randomizeFrequencyBands"
        :title="t('audioPanel.randomizeFrequencies')"
      >
        <iconify-icon icon="ph:dice-three-duotone"></iconify-icon>
      </button>
    </template>
    ...
    <div class="slider-group">
      <BaseSlider
        :label="t('audioPanel.bass')"
        :description="t('audioPanel.bassDesc')"
        :min="0"
        :max="2"
        :step="0.05"
        v-model="audio.frequencySpikes.bass"
      />
      <BaseSlider
        :label="t('audioPanel.mid')"
        :description="t('audioPanel.midDesc')"
        :min="0"
        :max="2"
        :step="0.05"
        v-model="audio.frequencySpikes.mid"
      />
      <BaseSlider
        :label="t('audioPanel.high')"
        :description="t('audioPanel.highDesc')"
        :min="0"
        :max="2"
        :step="0.05"
        v-model="audio.frequencySpikes.high"
      />
    </div>
  </PanelSection>
</template>
